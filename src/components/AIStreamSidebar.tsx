        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="mb-6 space-y-4 shrink-0">
                <div className="flex items-center justify-between">
                    ...
                    <div className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider border ${status === 'speaking' ? 'bg-indigo-500/10 border-indigo-500/20 text-indigo-300' :
                            ...
                            >
                                {[...Array(16)].map((_, i) => (
                                    <motion.div
                                        ...
                                        className={`w-1 rounded-full transition-colors duration-500 ${status === 'listening' && volume > 0.1 ? 'bg-emerald-400 shadow-[0_0_15px_rgba(52,211,153,0.4)]' :
                ...
                <AnimatePresence initial={false}>
                    {messages.map((msg) => (
                        <motion.div
                            ...
                            className={`relative group p-4 rounded-2xl border transition-all duration-300 ${msg.role === 'ai'
